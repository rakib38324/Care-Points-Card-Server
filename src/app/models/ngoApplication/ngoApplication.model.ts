...
import { TNGOApplication } from './ngoApplication.interface'; // Adjust path as needed
 ...
 */
const ngoApplicationSchema = new Schema<TNGOApplication>(
  {
 ...
 * ================= Model Export =================
 */
export const NGOApplication = model<TNGOApplication>(
  'NGOApplication',
  ngoApplicationSchema,
);
